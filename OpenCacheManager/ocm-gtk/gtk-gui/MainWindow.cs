...
public partial class MainWindow {
    ...
    private Gtk.Action LocationsAction5;
    
    private Gtk.Action AddLocationAction1;
    
    private Gtk.Action DeleteLocationAction1;
    
    private Gtk.Action LocationsMenu;
    
    private Gtk.Action HomeAction1;
    
    private Gtk.Action AddGPSProfileAction;
    
    private Gtk.Action DeleteGPSProfileAction;
    
    private Gtk.Action GPSProfileAction;
    
    private Gtk.Action ProcessFieldNotesAction;
    ...
    private Gtk.Action ClearOfflineLogsAction;
    
    private Gtk.Action FieldNotesAction;
    
    private Gtk.Action ViewFieldNotesAction;
    
    private Gtk.Action ClearFieldNotesAction;
    ...
    protected virtual void Build() {
        ...
        w1.Add(this.ImportDirectoryAction, "<Control><Alt><Mod2>i");
        this.StatisticsAction = new Gtk.Action("StatisticsAction", Mono.Unix.Catalog.GetString("Statistics..."), null, null);
        this.StatisticsAction.ShortLabel = Mono.Unix.Catalog.GetString("Statistics...");
        ...
        this.AddChildWaypointAction.Sensitive = false;
        ...
        this.AddLocationAction = new Gtk.Action("AddLocationAction", Mono.Unix.Catalog.GetString("Add Location..."), null, null);
        this.AddLocationAction.ShortLabel = Mono.Unix.Catalog.GetString("Add Location...");
        w1.Add(this.AddLocationAction, null);
        this.LocationsAction = new Gtk.Action("LocationsAction", Mono.Unix.Catalog.GetString("Locations"), null, null);
        this.LocationsAction.ShortLabel = Mono.Unix.Catalog.GetString("Locations");
        w1.Add(this.LocationsAction, null);
        this.HomeAction = new Gtk.Action("HomeAction", Mono.Unix.Catalog.GetString("Home"), null, null);
        this.HomeAction.ShortLabel = Mono.Unix.Catalog.GetString("Home");
        w1.Add(this.HomeAction, null);
        this.DeleteLocationAction = new Gtk.Action("DeleteLocationAction", Mono.Unix.Catalog.GetString("Delete Location..."), null, null);
        this.DeleteLocationAction.ShortLabel = Mono.Unix.Catalog.GetString("Delete Location...");
        w1.Add(this.DeleteLocationAction, null);
        this.LocationsAction5 = new Gtk.Action("LocationsAction5", Mono.Unix.Catalog.GetString("_Locations"), null, null);
        this.LocationsAction5.ShortLabel = Mono.Unix.Catalog.GetString("_Locations");
        w1.Add(this.LocationsAction5, null);
        this.AddLocationAction1 = new Gtk.Action("AddLocationAction1", Mono.Unix.Catalog.GetString("_Add Location..."), null, null);
        this.AddLocationAction1.ShortLabel = Mono.Unix.Catalog.GetString("_Add Location...");
        w1.Add(this.AddLocationAction1, null);
        this.DeleteLocationAction1 = new Gtk.Action("DeleteLocationAction1", Mono.Unix.Catalog.GetString("_Delete Location..."), null, null);
        this.DeleteLocationAction1.ShortLabel = Mono.Unix.Catalog.GetString("_Delete Location...");
        w1.Add(this.DeleteLocationAction1, null);
        this.LocationsMenu = new Gtk.Action("LocationsMenu", Mono.Unix.Catalog.GetString("L_ocations"), null, null);
        this.LocationsMenu.ShortLabel = Mono.Unix.Catalog.GetString("L_ocations");
        w1.Add(this.LocationsMenu, null);
        this.HomeAction1 = new Gtk.Action("HomeAction1", Mono.Unix.Catalog.GetString("Home"), null, null);
        this.HomeAction1.ShortLabel = Mono.Unix.Catalog.GetString("Home");
        w1.Add(this.HomeAction1, null);
        this.AddGPSProfileAction = new Gtk.Action("AddGPSProfileAction", Mono.Unix.Catalog.GetString("Add GPS Profile..."), null, null);
        this.AddGPSProfileAction.ShortLabel = Mono.Unix.Catalog.GetString("Add GPS Profile...");
        w1.Add(this.AddGPSProfileAction, null);
        this.DeleteGPSProfileAction = new Gtk.Action("DeleteGPSProfileAction", Mono.Unix.Catalog.GetString("Delete GPS Profile..."), null, null);
        this.DeleteGPSProfileAction.ShortLabel = Mono.Unix.Catalog.GetString("Delete GPS Profile...");
        w1.Add(this.DeleteGPSProfileAction, null);
        this.GPSProfileAction = new Gtk.Action("GPSProfileAction", Mono.Unix.Catalog.GetString("GPS Profile"), null, null);
        this.GPSProfileAction.ShortLabel = Mono.Unix.Catalog.GetString("GPS Profile");
        w1.Add(this.GPSProfileAction, null);
        this.ProcessFieldNotesAction = new Gtk.Action("ProcessFieldNotesAction", Mono.Unix.Catalog.GetString("Process Field Notes..."), null, null);
        this.ProcessFieldNotesAction.ShortLabel = Mono.Unix.Catalog.GetString("Process Field Notes...");
        w1.Add(this.ProcessFieldNotesAction, null);
        this.EditGPSProfileAction = new Gtk.Action("EditGPSProfileAction", Mono.Unix.Catalog.GetString("Edit GPS Profile..."), null, null);
        this.EditGPSProfileAction.ShortLabel = Mono.Unix.Catalog.GetString("Edit GPS Profile...");
        w1.Add(this.EditGPSProfileAction, null);
        this.MarkDidNotFindAction = new Gtk.Action("MarkDidNotFindAction", Mono.Unix.Catalog.GetString("Mark Did Not Find"), null, null);
        this.MarkDidNotFindAction.ShortLabel = Mono.Unix.Catalog.GetString("Mark Did Not Find");
        w1.Add(this.MarkDidNotFindAction, null);
        this.MarkFirstToFindAction = new Gtk.Action("MarkFirstToFindAction", Mono.Unix.Catalog.GetString("Mark First To Find"), null, null);
        this.MarkFirstToFindAction.ShortLabel = Mono.Unix.Catalog.GetString("Mark First To Find");
        ...
        this.ClearOfflineLogsAction = new Gtk.Action("ClearOfflineLogsAction", Mono.Unix.Catalog.GetString("Clear Offline Logs..."), null, null);
        this.ClearOfflineLogsAction.ShortLabel = Mono.Unix.Catalog.GetString("Clear Offline Logs...");
        w1.Add(this.ClearOfflineLogsAction, null);
        this.FieldNotesAction = new Gtk.Action("FieldNotesAction", Mono.Unix.Catalog.GetString("Field Notes"), null, null);
        this.FieldNotesAction.ShortLabel = Mono.Unix.Catalog.GetString("Field Notes");
        w1.Add(this.FieldNotesAction, null);
        this.ViewFieldNotesAction = new Gtk.Action("ViewFieldNotesAction", Mono.Unix.Catalog.GetString("View Field Notes..."), null, null);
        this.ViewFieldNotesAction.ShortLabel = Mono.Unix.Catalog.GetString("View Field Notes...");
        w1.Add(this.ViewFieldNotesAction, null);
        this.ClearFieldNotesAction = new Gtk.Action("ClearFieldNotesAction", Mono.Unix.Catalog.GetString("Clear Field Notes..."), null, null);
        this.ClearFieldNotesAction.ShortLabel = Mono.Unix.Catalog.GetString("Clear Field Notes...");
        w1.Add(this.ClearFieldNotesAction, null);
        ...
        this.UIManager.AddUiFromString("<ui><menubar name='mainmenubar'><menu name='FileAction' action='FileAction'><menuitem name='newAction1' action='newAction1'/><menuitem name='openAction2' action='openAction2'/><separator/><menuitem name='openAction' action='openAction'/><menuitem name='ImportZIPFileAction' action='ImportZIPFileAction'/><menuitem name='ImportDirectoryAction' action='ImportDirectoryAction'/><menuitem name='saveAsAction' action='saveAsAction'/><menuitem name='ExportFindsGPXAction' action='ExportFindsGPXAction'/><separator/><menuitem name='printAction' action='printAction'/><separator/><menuitem name='QuitAction' action='QuitAction'/></menu><menu name='EditAction' action='EditAction'><menuitem name='PreferencesAction1' action='PreferencesAction1'/></menu><menu name='FilterAction' action='FilterAction'><menuitem name='QuickFilterAction' action='QuickFilterAction'/><separator/><menuitem name='AdvancedFiltersAction' action='AdvancedFiltersAction'/><menuitem name='ClearAdvancedFiltersAction' action='ClearAdvancedFiltersAction'/><menuitem name='ClearAllFiltersAction1' action='ClearAllFiltersAction1'/><separator/><menuitem name='SaveCurrentViewAsQuickFilterAction' action='SaveCurrentViewAsQuickFilterAction'/><menuitem name='DeleteQuickFilterAction' action='DeleteQuickFilterAction'/></menu><menu name='CacheAction' action='CacheAction'><menuitem name='LogFindAction' action='LogFindAction'/><menuitem name='LogToFieldNotesFileAction' action='LogToFieldNotesFileAction'/><separator/><menu name='MarkAction' action='MarkAction'><menuitem name='MarkFoundAction' action='MarkFoundAction'/><menuitem name='MarkFirstToFindAction' action='MarkFirstToFindAction'/><menuitem name='MarkDidNotFindAction' action='MarkDidNotFindAction'/><menuitem name='MarkUnfoundAction1' action='MarkUnfoundAction1'/><menuitem name='MarkDisabledAction1' action='MarkDisabledAction1'/><menuitem name='MarkArchivedAction1' action='MarkArchivedAction1'/><menuitem name='MarkAvailableAction1' action='MarkAvailableAction1'/></menu><menuitem name='AddChildWaypointAction' action='AddChildWaypointAction'/><menuitem name='CorrectedCoordinatesAction' action='CorrectedCoordinatesAction'/><separator/><menuitem name='ViewOnlineAction' action='ViewOnlineAction'/><separator/><menuitem name='AddCacheAction' action='AddCacheAction'/><menuitem name='ModifyCacheAction' action='ModifyCacheAction'/><menuitem name='DeleteCacheAction' action='DeleteCacheAction'/><menuitem name='DeleteAllVisibleCachesAction' action='DeleteAllVisibleCachesAction'/><separator/><menuitem name='DeselectCacheAction' action='DeselectCacheAction'/></menu><menu name='FieldNotesAction' action='FieldNotesAction'><menuitem name='ViewFieldNotesAction' action='ViewFieldNotesAction'/><separator/><menuitem name='ClearFieldNotesAction' action='ClearFieldNotesAction'/></menu><menu name='DatabaseAction' action='DatabaseAction'><menuitem name='CopyCachesToAnotherDatabaseAction' action='CopyCachesToAnotherDatabaseAction'/><menuitem name='MoveCachesToAnotherDatabaseAction' action='MoveCachesToAnotherDatabaseAction'/><separator/><menuitem name='CompactDatabaseAction2' action='CompactDatabaseAction2'/></menu><menu name='WebAction' action='WebAction'><menuitem name='OCMHomePageAction' action='OCMHomePageAction'/><separator/><menu name='GeocachingComAction1' action='GeocachingComAction1'><menuitem name='HomePageAction5' action='HomePageAction5'/><menuitem name='ViewMyProfileAction1' action='ViewMyProfileAction1'/><menuitem name='MyAccountDetailsAction1' action='MyAccountDetailsAction1'/><menuitem name='CreatePocketQueriesAction1' action='CreatePocketQueriesAction1'/><menuitem name='StatisticsAction' action='StatisticsAction'/><separator/><menuitem name='FindACacheAction1' action='FindACacheAction1'/></menu><menu name='TerraCachingComAction1' action='TerraCachingComAction1'><menuitem name='HomePageAction' action='HomePageAction'/><separator/><menu name='ToDoListAction1' action='ToDoListAction1'><menuitem name='TraditionalAction1' action='TraditionalAction1'/><menuitem name='LocationlessAction1' action='LocationlessAction1'/></menu></menu><menu name='NaviCacheComAction1' action='NaviCacheComAction1'><menuitem name='HomePageAction7' action='HomePageAction7'/><menuitem name='MyNaviCacheAction1' action='MyNaviCacheAction1'/></menu><menu name='OpencachingAction' action='OpencachingAction'><menuitem name='ListOfCountrySitesAction' action='ListOfCountrySitesAction'/></menu><separator/><menuitem name='GPSBabelHomePageAction' action='GPSBabelHomePageAction'/><menuitem name='GPSDHomePageAction' action='GPSDHomePageAction'/></menu><menu name='LocationsAction5' action='LocationsAction5'><menu name='LocationsMenu' action='LocationsMenu'/><separator/><menuitem name='AddLocationAction1' action='AddLocationAction1'/><menuitem name='DeleteLocationAction1' action='DeleteLocationAction1'/></menu><menu name='MapAction' action='MapAction'><menuitem name='ShowNearbyCachesAction' action='ShowNearbyCachesAction'/><menu name='ChildWaypointsAction' action='ChildWaypointsAction'><menuitem name='SelectedCacheOnlyAction1' action='SelectedCacheOnlyAction1'/><menuitem name='AllWaypointsAction' action='AllWaypointsAction'/></menu><separator/><menuitem name='ZoomToCentreAction' action='ZoomToCentreAction'/><menuitem name='ZoomToSelectedCacheAction' action='ZoomToSelectedCacheAction'/><menuitem name='SetSelectedCacheAsCentreAction' action='SetSelectedCacheAsCentreAction'/><menuitem name='ResetCentreToHomeAction' action='ResetCentreToHomeAction'/><separator/><menuitem name='UseGPSDAsCentreAction' action='UseGPSDAsCentreAction'/><menuitem name='ConfigureGPSDAction' action='ConfigureGPSDAction'/></menu><menu name='GPSAction' action='GPSAction'><menu name='GPSProfileAction' action='GPSProfileAction'/><menuitem name='TransferCachesAction' action='TransferCachesAction'/><menuitem name='ProcessFieldNotesAction' action='ProcessFieldNotesAction'/><separator/><menuitem name='AddGPSProfileAction' action='AddGPSProfileAction'/><menu name='EditGPSProfileAction' action='EditGPSProfileAction'/><menuitem name='DeleteGPSProfileAction' action='DeleteGPSProfileAction'/></menu><menu name='ToolsAction' action='ToolsAction'><menuitem name='ViewAllInQLandkarteGTAction' action='ViewAllInQLandkarteGTAction'/><menuitem name='ViewSelectedCacheInQLandkarteGTAction' action='ViewSelectedCacheInQLandkarteGTAction'/><separator/><menu name='ExternalToolsAction' action='ExternalToolsAction'/><menuitem name='ConfigureExternalToolsAction' action='ConfigureExternalToolsAction'/><separator/></menu><menu name='HelpAction' action='HelpAction'><menuitem name='OCMWikiAction' action='OCMWikiAction'/><separator/><menuitem name='aboutAction' action='aboutAction'/><menuitem name='ChangeHistoryAction' action='ChangeHistoryAction'/><separator/><menuitem name='CheckForUpdatesAction' action='CheckForUpdatesAction'/></menu><menu><menuitem/><menuitem/></menu></menubar></ui>");
        ...
        this.StatisticsAction.Activated += new System.EventHandler(this.OnClickStatistics);
        this.AddChildWaypointAction.Activated += new System.EventHandler(this.OnChildClick);
        this.AddLocationAction.Activated += new System.EventHandler(this.OnAddLocation);
        this.AddLocationAction1.Activated += new System.EventHandler(this.OnAddLocation);
        this.DeleteLocationAction1.Activated += new System.EventHandler(this.OnDeleteLocation);
        this.AddGPSProfileAction.Activated += new System.EventHandler(this.OnAddGPS);
        this.DeleteGPSProfileAction.Activated += new System.EventHandler(this.OnDeleteProfile);
        this.ProcessFieldNotesAction.Activated += new System.EventHandler(this.OnProcessFieldNotes);
        this.LogToFieldNotesFileAction.Toggled += new System.EventHandler(this.OnOfflineToggle);
        this.ViewFieldNotesAction.Activated += new System.EventHandler(this.OnViewFieldNotes);
        this.ClearFieldNotesAction.Activated += new System.EventHandler(this.OnClearFieldNotes);
    }
}
