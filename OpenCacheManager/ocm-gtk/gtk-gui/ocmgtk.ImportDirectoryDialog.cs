...
namespace ocmgtk {
    ...
    public partial class ImportDirectoryDialog {
        ...
        protected virtual void Build() {
            ...
            this.table1.Add(this.deleteCheck);
            Gtk.Table.TableChild w2 = ((Gtk.Table.TableChild)(this.table1[this.deleteCheck]));
            w2.TopAttach = ((uint)(1));
            ...
            Gtk.Table.TableChild w3 = ((Gtk.Table.TableChild)(this.table1[this.dirChooser]));
